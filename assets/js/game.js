// function to get valid input in fight or skip question
...
var startGame = function() {
    ...
    for(var i = 0; i < enemyInfo.length; i++) {
        if (playerInfo.health > 0) {
            ...
            window.alert('Welcome to Battelbots! Round ' + (i + 1) );
...
var endGame = function() {
    window.alert("The game has now ender. Let's see how you did!");
